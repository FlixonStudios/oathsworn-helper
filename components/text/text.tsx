...
export const Text = {
  ...
  H3: ({ children, ...rest }: BaseTextProps) =>
    getText({ fontSize: 26, fontWeight: "600" }, { children, ...rest }),
  H5: ({ children, ...rest }: BaseTextProps) =>
    getText({ fontSize: 20, fontWeight: "600" }, { children, ...rest }),
